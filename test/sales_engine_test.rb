...
class SalesEngineTest < MiniTest::Test
  ...
  def test_merchant_customers
    ...
    :transactions => "./data/transactions.csv",
    :customers => "./data/customers.csv"})
    invoice = se.invoices.find_by_id(2246)
  ...
  def test_invoice_customer
    ...
    :transactions => "./data/transactions.csv",
    :customers => "./data/customers.csv"})
    invoice = se.invoices.find_by_id(4236)

    assert_equal 838, invoice.customer.id
    assert_instance_of Customer, invoice.customer
  end
  ...
  def test_total
    ...
    assert_instance_of BigDecimal, invoice
  end
  ...
  def test_invoice_item_by_invoice_id
    ...
    :transactions => "./data/transactions.csv",
    :customers => "./data/customers.csv"})
    invoice = se.find_invoice_items_by_invoice_id(1)

    assert_instance_of Array, invoice
    assert_equal 8, invoice.count
  end

  def test_merchants_by_customer_id
    se = SalesEngine.from_csv({
    :items     => "./data/items.csv",
    :merchants => "./data/merchants.csv",
    :invoices => "./data/invoices.csv",
    ...
    :transactions => "./data/transactions.csv",
    :customers => "./data/customers.csv"})
    invoice = se.find_merchants_by_customer_id(1)
